...
public final class RegexType implements Serializable {
    ...
    public static final  String DATE_BASIC                 = new StringBuffer()
            .append( DATE_YYYY_MM_DD_HH_MM_SS )
            .append( "|" )
            .append( DATE_YYYY_MM_DD )
            .append( "|" )
            .append( DATE_YYYY_MM_DD_HH_MM_SS_2 )
            .append( "|" )
            .append( DATE_YYYY_MM_2 )
            .append( "|" )
            .append( DATE_YYYY_MM_DD_HH_MM_SS_3 )
            .append( "|" )
            .append( DATE_YYYY_MM_3 )
            .toString();
    // 邮箱校验
